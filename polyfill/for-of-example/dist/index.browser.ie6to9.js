...
var ForOfExample = (function (exports) {
  ...
  */
  ...
  function () {
    ...
    createClass(Person, [{
      ...
      value: function toString() {
        ...
        var name = this.name;
        var text = this.lang ? introductions[this.lang] : introductions.en;
        return concat$2(_context = "".concat(text, " ")).call(_context, name);
      }
    }]);
  ...
  var index = (function (people) {
    ...
    try {
      for (var _iterator = getIterator$2(people), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        var someone = _step.value;

        var _ref = someone || {},
            _ref$name = _ref.name,
            name = _ref$name === void 0 ? 'John Doe' : _ref$name;

        var p = new Person(name); // for (const [k, v] of Object.entries(rest)) {
        //   p[k] = v
        // }
